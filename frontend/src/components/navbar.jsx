            ...
            <div className="container">
                <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start" >
                    ...
                    <form className="col-12 align-items-center justify-content-center col-lg-auto mb-3 mb-lg-0 me-lg-3 section" role="search">
                        ...
                        <NavLink to="/dashboardredirects" className="d-block d-flex link-body-emphasis text-decoration-none text-decoration-noneVercel" data-bs-toggle="dropdown" aria-expanded="false">
