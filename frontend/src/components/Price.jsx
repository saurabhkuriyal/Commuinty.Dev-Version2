...
export default function Price() {
    ...
    function handlePremiumClick(){
        alert("Currently free for everyone so signup and enjoy")
        navigate('/signup')
    }
  return (
    <div>
            ...
            <div className="col">
                <div className="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div className="card-body">
                        ...
                        <button type="button" onClick={handlePremiumClick} className="w-100 btn btn-lg btn-warning">Get started</button>
                    </div>
                </div>
            </div>
            <div className="col">
                <div className="card mb-4 rounded-3 shadow-sm border-danger">
                    ...
                    <div className="card-body">
                        ...
                        <button type="button" onClick={handlePremiumClick} className="w-100 btn btn-lg btn-danger">Contact us</button>
                    </div>
                </div>
            </div>
        </div>
